...
// ============================================================
export const createEvaluationService = async (supervisorId, dto) => {
    ...
    const existing = await db
        ...
        .from(evaluations)
        .where(and(eq(evaluations.studentId, dto.studentId), eq(evaluations.supervisorId, supervisorId)))
        .limit(1);
...
// ============================================================
export const getStudentEvaluationsService = async (studentId, supervisorId) => {
    const whereClause = and(eq(evaluations.studentId, studentId), ...(supervisorId ? [eq(students.supervisorId, supervisorId)] : []));
...
// ============================================================
export const getAllEvaluationsService = async (rawPage, rawLimit) => {
...
// ============================================================
export const getEvaluationByIdService = async (evaluationId, supervisorId) => {
    const whereClause = and(eq(evaluations.id, evaluationId), ...(supervisorId ? [eq(students.supervisorId, supervisorId)] : []));
    const result = await db
        .select({
        evaluationId: evaluations.id,
        performanceScore: evaluations.performanceScore,
...
// ============================================================
export const updateEvaluationService = async (evaluationId, supervisorId, dto) => {
    const existing = await db
...
// ============================================================
export const getStudentAverageScoreService = async (studentId) => {
    const result = await db
        .select({
        performanceScore: evaluations.performanceScore,
        communicationScore: evaluations.communicationScore,
